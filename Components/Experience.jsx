...
const Experience = () => {
    return (
        ...
        <div className="row mt-5 exp-sec">
          <div className="col-md-6 ">
            <div className="sticky-lg-top">
              ...
              <h2>
              Get experienced. <span className='main-color spn-sty' >Without risks.</span> 
              </h2>
              <p>
		...
		<svg width="190px" height="60px" viewBox="0 0 180 60" className="border1">
          ...
          <br className="br-hide" />
          <br className="br-hide" />
          <img src="assets/img/experience-2.png" className="mt-5 mt-lg-0 img-fluid" alt="points image" />
          <br className="br-hide" />
          <br className="br-hide" />
          <br className="br-hide" />
          <br className="br-hide" />
          <br className="br-hide" />
          <img src="assets/img/experience-3.png" className="mt-5 mt-lg-0 img-fluid" alt="points image" />
          </div>
        </div>
      </div>  
        </>
